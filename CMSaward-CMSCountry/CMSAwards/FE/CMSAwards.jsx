...
//         },
//         body: JSON.stringify(editAward) // This was wrong, use newAward instead.
//       });
...
//       const data = await response.json();
//       setAwards(awards.map(award => (award.award_id === id ? data : award)));
//       setFilteredAwards(filteredAwards.map(award => (award.award_id === id ? data : award)));
...
//                                 setEditAward({ country_id: award.country_id, year: award.year, award_name: award.award_name });
//                               }}
